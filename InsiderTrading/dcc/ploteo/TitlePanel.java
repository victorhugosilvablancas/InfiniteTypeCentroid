...
public class TitlePanel extends JPanel {
     ...
     */
    public TitlePanel(String aclusters,String aepochs) {
        ...
        Ellipse2D mipunto;
        Titlesdata data=new Titlesdata();
        for (int i=0;i<Titlesdata.listtitles.size();i++) {
            data=Titlesdata.listtitles.get(i);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("B-Underlying Security Shares", 20, 100);
        //c-point
        g2.drawLine(14,440,500,114);
        g2.drawString("C-Total Titles", 300, 200);
