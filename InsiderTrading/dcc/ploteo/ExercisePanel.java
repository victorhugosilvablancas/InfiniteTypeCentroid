...
public class ExercisePanel extends JPanel {
     ...
     */
    public ExercisePanel(String aclusters,String aepochs) {
        n_clusters=Integer.valueOf(aclusters);
        n_epochs=Integer.valueOf(aepochs);
        mylist=new ArrayList<>();
        kfe=new KmeansForExercises();
        ...
        for (int i=0;i<Exercisesdata.listexercises.size();i++) {
            data=Exercisesdata.listexercises.get(i);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("A-Exercise Date Function", 100, 420);
        //b-point
    ...
    private class KmeansForExercises extends Kmeans {
        
        public KmeansForExercises() {
        }
        public void Execute() {
            ...
            for(int j = 0; j < Kmeans.Cluster.length; j++) {
                ...
                int k=rn.nextInt(0, Exercisesdata.listexercises.size());
                Exercisesdata tdata=Exercisesdata.listexercises.get(k);
        ...
        */
        public final void DataInitialization() {
            ...
            Exercisesdata dfdata=new Exercisesdata();
            for (int i=0;i<Exercisesdata.listexercises.size();i++) {
                dfdata=Exercisesdata.listexercises.get(i);
                
                midato=new Datasdata(dfdata);
